...
__global__ void MatchSiftPoints2(SiftPoint *sift1, SiftPoint *sift2,
                                 float *corrData, int numPts1, int numPts2) {
...
__global__ void FindMaxCorr(float *corrData, SiftPoint *sift1, SiftPoint *sift2,
                            int numPts1, int corrWidth, int siftSize) {
...
__global__ void FindMaxCorr3(float *corrData, SiftPoint *sift1,
                             SiftPoint *sift2, int numPts1, int numPts2) {
...
__global__ void FindMaxCorr2(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
    __shared__ float siftPoint[128];
...
__global__ void FindMaxCorr4(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
...
__global__ void FindMaxCorr9(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
...
__global__ void FindMaxCorr8(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
    __shared__ float4 siftParts1[FMC_BW * FMC_BD];  // 4*32*8 = 1024
    __shared__ float4 siftParts2[FMC_BH * FMC_BD];  // 4*32*8 = 1024
    __shared__ float blksums[FMC_BW * FMC_BH];      // 32*32  = 1024
...
__global__ void FindMaxCorr7(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
...
__global__ void FindMaxCorr6(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
...
__global__ void FindMaxCorr5(SiftPoint *sift1, SiftPoint *sift2, int numPts1,
                             int numPts2) {
...
__global__ void TestHomographies(float *d_coord, float *d_homo, int *d_counts,
